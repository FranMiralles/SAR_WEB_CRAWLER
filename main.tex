...
A la hora de crear el índice de \textit{permuterms} para los términos de todos los índices debemos de iterar por todos los campos indexados (depende de la opción multifield) y calcular el índice de permuterms del término con las rotaciones de cada subcadena con el símbolo '\$' de la forma vista en teoría. Hemos decidido emplear una función llamada "generate\_permuterms()" para externalizar el propio cálculo del permuterm. Deberemos almacenar el término generado por su permuterm en self.ptindex.
